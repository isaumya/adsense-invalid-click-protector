...
* For some users who are using cloudflare on their server facing issue that the user IP is not getting reflected on the pluhin. Instead the plugin was shoing the server IP as the user IP. This issue is now fixed. Thanks to [@coolph](https://profiles.wordpress.org/coolph/) for providing a testing enviroinment to test and fix this issue.

= 1.2.2, April 6, 2018 =

* Added new demostration video in youtube embed.
